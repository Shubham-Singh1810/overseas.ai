...
import {addHighestEduCertificate} from '../services/user.service';
    ...
    try {
      ...
      if (
        ...
        Toast.show({
          ...
          setUri(response?.data?.eduCertUrl)
      }
    } catch (err) {
      ...
      <View
        ...
        <View style={{width: '100%'}}>
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            ...
            <View style={{width: '45%'}}>
              <Button title={newTranslation?.update} color="#035292" onPress={uploadEducationCertificate} />
            </View>
          </View>
        </View>
      </View>
